...
fig = px.scatter_mapbox(bmp_df, hover_name='Name', hover_data=['Address', 'City', 'State', 'Zip','Website', 'Phone' ],lat='Latitude', lon="Longitude", zoom=2, center = {"lat": 37.0902, "lon": -95.7129}, color_continuous_scale=['red', 'black'], color="State",size_max=30,   title='Breweries across the US',
                       )
